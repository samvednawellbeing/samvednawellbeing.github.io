...
const IndexPage = () => {
  ...
  return (
    <amp-story
      ...
      poster-portrait-src="/images/mt.jpg"
    >
      ...
      <amp-story-page id="page1" auto-advance-after="5s">
        <amp-story-grid-layer template="vertical">
          <h1>Cats</h1>
          <amp-img
            src="https://wallpapercave.com/wp/wp2757328.jpg"
            width="720"
            height="1280"
            layout="responsive"
            animate-in="pulse"
      ...
      <amp-story-page id="page2" auto-advance-after="5s">
        <amp-story-grid-layer template="fill">
          <amp-img
            src="https://wallpapercave.com/wp/wp3682616.jpg"
            width="720"
            height="1280"
            layout="responsive"
          ></amp-img>
      ...
      <amp-story-page
        id="page3"
        background-audio="https://file-examples.com/wp-content/storage/2017/11/file_example_MP3_700KB.mp3"
      >
        <amp-story-grid-layer template="fill">
          <amp-img
            src="https://wallpapercave.com/wp/wp2757308.jpg"
            width="720"
            height="1280"
            layout="responsive"
          ></amp-img>
      ...
      <amp-story-page id="page4" auto-advance-after="2s">
        <amp-story-grid-layer template="fill">
          ...
          >
            <source
              src="https://videos.pexels.com/video-files/5057524/5057524-uhd_2160_3840_25fps.mp4"
              type="video/mp4"
            />
          </amp-video>
        </amp-story-grid-layer>
      ...
      <amp-story-page id="page5">
        <amp-story-grid-layer template="vertical" className="noedge">
          <div className="wrapper">
            ...
            ></amp-img>
            <amp-img
              src="https://wallpapercave.com/wp/wp3259019.jpg"
              width="720"
              height="1280"
              layout="responsive"
              animate-in="fade-in"

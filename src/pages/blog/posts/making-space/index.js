    ...
    <BaseLayout>
      ...
      <Row>
        <Col xs={12} sm={12} md={12} lg={12} xl={12} xxl={12}>
          ...
          <ul>
            <li>
              <Trans i18nKey={postTranslated.contentText.p6_1}></Trans>
            </li>
            <li>
              <Trans i18nKey={postTranslated.contentText.p6_2}></Trans>
            </li>
            <li>
              <Trans i18nKey={postTranslated.contentText.p6_3}></Trans>
            </li>
            <li>
              <Trans i18nKey={postTranslated.contentText.p6_4}></Trans>
            </li>
            <li>
              <Trans i18nKey={postTranslated.contentText.p6_5}></Trans>
            </li>
            <li>
              <Trans i18nKey={postTranslated.contentText.p6_6}></Trans>
            </li>
            <li>
              <Trans i18nKey={postTranslated.contentText.p6_7}></Trans>
            </li>
            <li>
              <Trans i18nKey={postTranslated.contentText.p6_8}></Trans>
            </li>
            <li>
              <Trans i18nKey={postTranslated.contentText.p6_9}></Trans>
            </li>
            <li>
              <Trans i18nKey={postTranslated.contentText.p6_10}></Trans>
            </li>
          </ul>
          <p>
